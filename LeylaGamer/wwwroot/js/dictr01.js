let suree = 0;
const soz = "Diğer anlamları için sözlüğe bakıyorum.";
const anlam = "Üzgünüm sözlükte anlamı bulunamadı";
...
; (function ($, window, document, undefined) {
    var pluginName = "countdown360",
        defaults = {
            ...
            label: ["Saniye", "Saniye"],    // the label to use or false if none
        ...
        _draw: function () {
            ...
            if (objgameKeyId.length > 0) {
                if (secondsElapsed > 0 && secondsElapsed < 15) {
                    ...
                    $(".result").text(obj[0].anlamlarListe[0] != undefined ? "1.Anlamı: " + obj[0].anlamlarListe[0].anlam : "" + anlam);
                    $('#sigortamnet').hide();
                    $('#arabamcom').hide();
                    $('#hepsiburada').hide();
                    $('#yemeksepeti').hide();
                    ...
                    var obj = objgameKeyId;
                    $(".result").text(obj[0].anlamlarListe[1] != undefined ? "2.Anlamı: " + obj[0].anlamlarListe[1].anlam : "1.Anlamı: " + obj[0].anlamlarListe[0].anlam);
                    $('#sigortamnet').hide();
                    $('#arabamcom').hide();
                    $('#hepsiburada').hide();
                    $('#yemeksepeti').hide();
                    ...
                    var obj = objgameKeyId;
                    $(".result").text(obj[0].anlamlarListe[2] != undefined ? "3.Anlamı: " + obj[0].anlamlarListe[2].anlam : "1.Anlamı: " + obj[0].anlamlarListe[0].anlam);
                    $('#sigortamnet').hide();
                    $('#arabamcom').hide();
                    $('#hepsiburada').show();
                    $('#yemeksepeti').hide();

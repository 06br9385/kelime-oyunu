let suree = 0;
const soz = "I'm looking in the dictionary for other meanings.";
const anlam = "Sorry meaning not found in dictionary.";
...
; (function ($, window, document, undefined) {
    var pluginName = "countdown360",
        defaults = {
            ...
            label: ["Second", "Second"],    // the label to use or false if none
    ...
    Plugin.prototype = {
        ...
        _draw: function () {
            ...
            suree = secondsElapsed + '.' + millisElapsed;
           
            if (objgameKeyId.length > 0) {
                if (secondsElapsed > 0 && secondsElapsed < 15) {
                    var obj = objgameKeyId;
                    $(".result").text(obj[0].meanings[0] != undefined ? "1.Meaning: " + obj[0].meanings[0].definitions[0].definition : "" + anlam);
                    $('#sigortamnet').hide();
                    $('#arabamcom').hide();
                    $('#hepsiburada').hide();
                    $('#yemeksepeti').hide();
                ...
                else if (secondsElapsed > 15 && secondsElapsed < 20) {
                    $(".result").text(soz);
                    $('#sigortamnet').hide();
                    $('#arabamcom').hide();
                    $('#hepsiburada').hide();
                ...
                else if (secondsElapsed > 20 && secondsElapsed < 35) {
                    var obj = objgameKeyId;
                    $(".result").text(obj[0].meanings[1] != undefined ? "2.Meaning: " + obj[0].meanings[0].definitions[1].definition : "1.Meaning: " + obj[0].meanings[0].definitions[0].definition);
                    $('#sigortamnet').hide();
                    $('#arabamcom').hide();
                    $('#hepsiburada').hide();
                    $('#yemeksepeti').hide();
                ...
                else if (secondsElapsed > 35 && secondsElapsed < 40) {
                    $(".result").text(soz);
                    $('#sigortamnet').hide();
                    $('#arabamcom').hide();
                    $('#hepsiburada').hide();
                ...
                else if (secondsElapsed > 40 && secondsElapsed < 55) {
                    var obj = objgameKeyId;
                    $(".result").text(obj[0].meanings[2] != undefined ? "3.Meaning: " + obj[0].meanings[0].definitions[2].definition : "1.Meaning: " + obj[0].meanings[0].definitions[0].definition);
                    $('#sigortamnet').hide();
                    $('#arabamcom').hide();
                    $('#hepsiburada').show();
                    $('#yemeksepeti').hide();
                ...
                else if (secondsElapsed > 55 && secondsElapsed < 59) {
                    $(".result").text(soz);
                    $('#sigortamnet').hide();
                    $('#arabamcom').show();
                    $('#hepsiburada').hide();
